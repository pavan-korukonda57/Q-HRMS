...
export default function PricingPlans() {
  ...
  return (
    <section
      className="text-center py-36 text-white relative bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage: "url('/assets/stories3.png')", // ✅ background image
      }}
    >
      {/* Overlay */}
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto text-lg leading-relaxed">
            ...
            whether you’re a growing startup or a large enterprise.
          </p>
        </div>
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                className={`relative flex-1 min-w-[360px] max-w-[440px] p-12 rounded-3xl cursor-pointer transform transition-all duration-300 ${
                  isSelected
              ...
              >
                ...
                <p className="text-gray-400 mb-10 text-base leading-relaxed">
                  Parturient elementum in, rutrum tristique inceptos sit suspendisse
                  faucibus velit.
                </p>

                <p className="text-5xl font-bold mb-8 text-blue-300">
                ...
                <a
                  href="#"
                  className={`flex items-center justify-between px-6 py-4 rounded-xl mb-10 text-lg font-semibold transition ${
                    isSelected
                ...
                <ul className="space-y-4 text-base text-gray-300 text-left">
